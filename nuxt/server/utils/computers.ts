export type ComputerStatus = 'active' | 'inactive' | 'maintenance'
...
export const getComputers = () => computers

export const getComputerById = (id: number) => computers.find((computer) => computer.id === id)
